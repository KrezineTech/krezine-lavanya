...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-auto items-center justify-start gap-x-8 border-b text-muted-foreground",
      className
    )}
    {...props}
  />
