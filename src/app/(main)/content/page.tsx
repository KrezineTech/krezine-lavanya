...
import { PlayCircle, Upload, MoreVertical, Eye, Trash2, Copy } from 'lucide-react';
...
export default function ContentPage() {
    ...
    // fetch media from backend on mount
    useEffect(() => {
        let mounted = true
        ;(async () => {
            try {
                ...
                setMedia(prev => {
                    // keep any in-memory newly added (not persisted) items and append fetched ones
